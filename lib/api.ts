...
function tiersFromOffer(
  offer:
    | Offer<true>
    | { id: string; basePrice: string; shipPrice: string | null },
): UIProduct[] {
...
export async function getComments(): Promise<Comment[]> {
  return [
    ...
    },
    {
      ...
      avatarId: 55,
      messages: [
        "Honest question — has anyone actually tried this or is everyone just reacting to the video?",
      ],
      timeAgo: "45m",
      reactions: "23",
    },
    {
      ...
      avatarId: 63,
      messages: [
        "David I ordered mine three weeks ago. Down 11 pounds and my afternoon cravings are completely gone.",
      ],
      timeAgo: "3h",
      reactions: "27",
    },
    ...
    },
    {
      ...
      avatarId: 42,
      messages: [
        "Has anyone seen real weight loss results? Or is the comment section just hype?",
      ],
      timeAgo: "2h",
      reactions: "33",
    },
    {
      ...
      avatarId: 51,
      messages: [
        "Sarah 14 lbs in 10 days for me. My wife started too and she's down 8 lbs in a week.",
      ],
      timeAgo: "2h",
      reactions: "48",
    },
